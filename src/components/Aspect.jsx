    ...
    render() {
        return (
            <div className="Aspect">
                { Object.keys(this.props.aspects).map(aspect=><div 
                    style={{height: 300*this.props.aspects[aspect] + "px"}}
                    className={`aspect aspect--${aspect}`}
                    key={`aspect-${aspect}`}>
                        <span className="aspect__name">{`${aspect}: ${(this.props.aspects[aspect] < 1 ? this.props.aspects[aspect].toFixed(2) : this.props.aspects[aspect])} (${this.ratioCalculator(300, 300*this.props.aspects[aspect])})`}</span>
                        <input 
                            type="range" 
                            ...
                            min="0.1" 
                            max="5.0" 
                            step={this.props.aspects[aspect] < 1 ?"0.05":"0.1"} 
                            onChange={
                ...
                <div className="mini-aspects">
                    {Object.keys(this.props.aspects).map(aspect=><div 
                        style={{height: 1*this.props.aspects[aspect] + "em"}}
